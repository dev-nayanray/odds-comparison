<?php
/**
 * Matches Archive Template with Sidebar
 *
...
<div class="oc-archive-with-sidebar">
    
    <!-- Main Content -->
    <main class="oc-archive-main">
                ...
                <?php while ( $matches_query->have_posts() ) : $matches_query->the_post(); ?>
                    ...
                    <article class="oc-match-card<?php echo $is_live ? ' live' : ''; echo $is_featured ? ' featured' : ''; ?>">
                        ...
                        <div class="oc-match-footer">
                            <span><?php echo count( $odds ); ?> <?php esc_html_e( 'bookmakers', 'odds-comparison' ); ?></span>
